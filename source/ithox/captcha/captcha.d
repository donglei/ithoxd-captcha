...
///颜色库
package enum string[] ITHOX_CAPTCHA_COLOR = ["red", "blue", "gree", "#FF4040", "#F08080", "#4B0082", "#9B30FF", "#8B5A00", "#7FFF00", "#48D1CC", "#00C5CD", "#AB82FF", "#8B2323"];
///字体
...
class IthoxCaptcha{
	...
	void[] render(string image_format = "gif")
	{
		...
		return image.toBlob(image_format);
	}
